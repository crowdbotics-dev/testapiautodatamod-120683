...
## Project Structure
    ...
    ├── testapiautodatamod_120683  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_120683`
...
2. Clone this repo and `cd testapiautodatamod_120683`
